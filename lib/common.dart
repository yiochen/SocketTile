...
String newDirM(String TAG,int dir,int id)=>JSON.encode({'from':TAG,'message':m_dir,'value':dir,'id':id});
String startMoveM(String TAG,int id)=>JSON.encode({'from':TAG,'message':m_startmove,'id':id});
String endMoveM(String TAG,int id)=>JSON.encode({'from':TAG,'message':m_endmove,'id':id});
